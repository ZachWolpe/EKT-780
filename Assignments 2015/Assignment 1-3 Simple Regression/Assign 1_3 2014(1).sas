...
call reg ;
/*print bh ess tss rss f p_f cv r2 ar2;*/
/*print bh seb t p_t;*/
...
cnm={"df" "Par est" "SEB" "t" "p_t" "cll" "clu"} ;
rnm={"Int" "x1" "x2" "d11" "d21" "d22"} ;
...
Fr=((m_r2-r2)/2)/((1-m_r2)/(n-k1)) ;
p_fr = 1-probf(fr,2,n-k1) ;
print fr p_fr ;
